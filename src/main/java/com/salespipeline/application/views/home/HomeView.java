package com.salespipeline.application.views.home;
...
public class HomeView extends Div implements AfterNavigationObserver {
 ...
 //Beispiel Feed für Neuigkeiten etc. anlegen
    ...
    public void afterNavigation(AfterNavigationEvent event) {
        ...
        // Beispieldaten mit Randomuser bildern. Soll einen Feed darstellen.
        List<Person> persons = Arrays.asList( //
        createPerson("https://randomuser.me/api/portraits/men/42.jpg", "Tim Muscholl", "Jan 12",
                "Wir haben diesen Code geschrieben.",
                "100M", "50000", "20000"),
        createPerson("https://randomuser.me/api/portraits/women/42.jpg", "Abagail Libbie", "May 3",
                "In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
                "1K", "500", "20"),
        createPerson("https://randomuser.me/api/portraits/men/24.jpg", "Valentin Kieslinger", "May 3",

                "In publishing and graphic design, Tim Muscholl text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
                "1K", "500", "20"),
        ...
        createPerson("https://randomuser.me/api/portraits/men/76.jpg", "Alf Huncoot", "Apr 21",
                ...
                "In publishing and graphic design, Lorem ipsum is a EASTER EGG used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
                "1K", "500", "20"),
        ...
        createPerson("https://randomuser.me/api/portraits/men/16.jpg", "Ivan Polo", "Mar 5",
                ...
                "In publishing and SKIFAHREN ipsum is a placeholder text commonly used to demonstrate the visual form of a document without relying on meaningful content (also called greeking).",
                "1K", "500", "20"),
