package com.salespipeline.application.views.admin;

import com.salespipeline.application.data.entity.Person;
import com.salespipeline.application.data.service.PersonService;
...
//Daten binden | Entity Person
    ...
    public AdminView(@Autowired PersonService personService) {
        ...
        cancel.addClickListener(e -> {
            clearForm();
            refreshGrid();  //Funktion Button Cancel
        });
        ...
        save.addClickListener(e -> {
            try {
                ...
                Notification.show("Somethin went wrong during storing process.");
            }
        }); //Funktion Button Save
